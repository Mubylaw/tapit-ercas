...
exports.sendInvite = asyncHandler(async (req, res, next) => {
  ...
  const emailResetUrl = `https://bfics.buildsure.ng/invite/${resetToken}`;

  // send reset email
  // const send_email_url = "https://api.brevo.com/v3/smtp/email";

  const message = `You are receiving this message because ${inviter.firstName} has invited you to create an account on BFICS. Please go to: \n\n ${emailResetUrl}`;
